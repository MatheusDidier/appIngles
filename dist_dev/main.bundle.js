...
module.exports = "<app-topo></app-topo>\n<div *ngIf=\"jogoEmAndamento; else finalDeJogo\">\n  <app-painel (encerrarJogo)=\"encerrarJogo($event)\"></app-painel>\n</div>\n<ng-template #finalDeJogo>\n  <div *ngIf=\"venceu  \">\n    <div class=\"container\" style=\"margin-top: 50px;\">\n      <div class=\"row\">\n        <div class=\"col\">\n          <h3 style=\"color: green;\">Parabéns, você venceu!</h3>\n          <button type=\"button\" (click)=\"reiniciarJogo()\" class=\"btn btn-primary\">Reiniciar jogo</button>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div *ngIf=\"!venceu\">\n    <div class=\"container\" style=\"margin-top: 50px;\">\n      <div class=\"row\">\n        <div class=\"col\">\n          <h3 style=\"color: red;\">Fim de jogo, infelizmente você perdeu :S</h3>\n          <button type=\"button\" (click)=\"reiniciarJogo()\" class=\"btn btn-primary\">Reiniciar jogo</button>\n        </div>\n      </div>\n    </div>\n  </div>\n</ng-template>\n"
...
var PainelComponent = /** @class */ (function () {
    ...
    PainelComponent.prototype.atualizaRodada = function () {
        ...
        console.log("Frases length -> ", this.frases.length);
...
module.exports = "<img [src]=\"coracao.existeCoracao()\"  *ngFor=\"let coracao of coracoes\">\n\n"
...
var TentativasComponent = /** @class */ (function () {
    function TentativasComponent() {
        this.coracoes = [
            new __WEBPACK_IMPORTED_MODULE_1__shared_coracao_model__["a" /* default */](true), new __WEBPACK_IMPORTED_MODULE_1__shared_coracao_model__["a" /* default */](true), new __WEBPACK_IMPORTED_MODULE_1__shared_coracao_model__["a" /* default */](true)
        ];
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["z" /* Input */])("tentativasN"),
        __metadata("design:type", Number)
...
var TopoComponent = /** @class */ (function () {
    function TopoComponent() {
        this.titulo = 'Aprendendo Inglês com pizza';
    }
